...
get_variable_expression_name(::ActivePowerVariable, ::Type{<:PSY.ThermalGen}) = nothing
...
get_variable_expression_name(::ReactivePowerVariable, ::Type{<:PSY.ThermalGen}) = nothing
