...
get_variable_lower_bound(::OnVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 0.0
get_variable_upper_bound(::OnVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 1.0

############## StopVariable, ThermalGen ####################
get_variable_binary(::StopVariable, ::Type{<:PSY.ThermalGen}, ::AbstractThermalFormulation) = true
get_variable_binary(::StopVariable, ::Type{<:PSY.ThermalGen}, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = false
...
get_variable_lower_bound(::StopVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 0.0
get_variable_upper_bound(::StopVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 1.0

############## StartVariable, ThermalGen ####################
get_variable_binary(::StartVariable, d::Type{<:PSY.ThermalGen}, ::AbstractThermalFormulation) = true
get_variable_binary(::StartVariable, ::Type{<:PSY.ThermalGen}, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = false
...
get_variable_lower_bound(::StartVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 0.0
get_variable_upper_bound(::StartVariable, d::PSY.ThermalGen, ::Union{ThermalContinousStandardUnitCommitment, ThermalContinousBasicUnitCommitment}) = 1.0
