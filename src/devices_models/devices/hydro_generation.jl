...
get_variable_expression_name(::ActivePowerVariable, ::Type{<:PSY.HydroGen}) = nothing
...
get_variable_expression_name(::ReactivePowerVariable, ::Type{<:PSY.HydroGen}) = nothing
...
get_variable_expression_name(::ActivePowerInVariable, ::Type{<:PSY.HydroGen}) = nothing
...
get_variable_expression_name(::ActivePowerOutVariable, ::Type{<:PSY.HydroGen}) = nothing
...
function add_constraints!(
    ...
    name = get_time_series_names(model)[EnergyBudgetTimeSeriesParameter]
    parameter =
        EnergyBudgetTimeSeriesParameter(get_default_time_series_type(container), name)
    param = get_parameter_array(container, parameter, V)
    multiplier = get_parameter_multiplier_array(container, parameter, V)
