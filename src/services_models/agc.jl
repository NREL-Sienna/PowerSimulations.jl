...
function balancing_auxiliary_variables!(psi_container, sys)
    ...
    assign_variable!(
        psi_container,
        variable_name("area_emergency_reserve_up"),
        R_up_emergency,
    )
    assign_variable!(
        psi_container,
        variable_name("area_emergency_reserve_dn"),
        R_dn_emergency,
    )
    emergency_up =
...
function frequency_response_constraint!(psi_container::PSIContainer, sys::PSY.System)
    ...
    R_up_emergency = get_variable(psi_container, variable_name("area_emergency_reserve_up"))
    R_dn_emergency = get_variable(psi_container, variable_name("area_emergency_reserve_dn"))
