struct SimulationModelStoreRequirements
    duals::Dict{IS.ConstraintKey, Dict{String, Any}}
    parameters::Dict{IS.ParameterKey, Dict{String, Any}}
    variables::Dict{IS.VariableKey, Dict{String, Any}}
    aux_variables::Dict{AuxVarKey, Dict{String, Any}}
    expressions::Dict{IS.ExpressionKey, Dict{String, Any}}
end

function SimulationModelStoreRequirements()
    return SimulationModelStoreRequirements(
        Dict{IS.ConstraintKey, Dict{String, Any}}(),
        Dict{IS.ParameterKey, Dict{String, Any}}(),
        Dict{IS.VariableKey, Dict{String, Any}}(),
        Dict{AuxVarKey, Dict{String, Any}}(),
        Dict{IS.ExpressionKey, Dict{String, Any}}(),
    )
end
