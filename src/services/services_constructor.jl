...
function get_devices(sys::PSY.ConcreteSystem,device::Type{PSY.ThermalGen})
    return sys.generators.thermal
end
function get_devices(sys::PSY.ConcreteSystem,device::Type{PSY.RenewableGen})
    return sys.generators.renewable
end
function get_devices(sys::PSY.ConcreteSystem,device::Type{PSY.HydroGen})
    return sys.generators.hydro
end
function get_devices(sys::PSY.ConcreteSystem,device::Type{PSY.PSY.ElectricLoad})
    return sys.loads
end
