function constructdevice!(m::JuMP.AbstractModel, netinjection::BalanceNamedTuple, category::Type{L}, category_formulation::Type{D}, system_formulation::Type{S}, sys::PowerSystems.PowerSystem; args...) where {L <: PowerSystems.ElectricLoad, D <: FullControllablePowerLoad, S <: PM.AbstractPowerFormulation}
...
function constructdevice!(m::JuMP.AbstractModel, netinjection::BalanceNamedTuple, category::Type{L}, category_formulation::Type{D}, system_formulation::Type{S}, sys::PowerSystems.PowerSystem; args...) where {L <: PowerSystems.ElectricLoad, D <: FullControllablePowerLoad, S <: AbstractACPowerModel}
