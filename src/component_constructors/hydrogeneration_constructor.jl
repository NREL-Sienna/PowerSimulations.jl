...
function constructdevice!(category::Type{Hydro}, transmission::Type{CopperPlatePowerModel}, m::JuMP.AbstractModel, devices_netinjection::T, sys::PSY.PowerSystem, constraints::Array{<:Function}=[powerconstraints]) where T <: JumpExpressionMatrix
