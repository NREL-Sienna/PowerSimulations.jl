...
"""
function constructdevice!(ps_m::CanonicalModel, netinjection::BalanceNamedTuple, category::Type{PSY.ThermalGen}, category_formulation::Type{D}, system_formulation::Type{S}, sys::PSY.PowerSystem; kwargs...) where {D <: AbstractThermalCommitmentForm, S <: AbstractDCPowerModel}
...
"""
function constructdevice!(ps_m::CanonicalModel, netinjection::BalanceNamedTuple, category::Type{PSY.ThermalGen}, category_formulation::Type{StandardThermalCommitment}, system_formulation::Type{S}, sys::PSY.PowerSystem; kwargs...) where {S <: AbstractDCPowerModel}

    constructdevice!(ps_m, netinjection, category, AbstractThermalCommitmentForm, AbstractDCPowerModel, sys; kwargs...)
...
function constructdevice!(ps_m::CanonicalModel, netinjection::BalanceNamedTuple, category::Type{PSY.ThermalGen}, category_formulation::Type{StandardThermalCommitment}, system_formulation::Type{CopperPlatePowerModel}, sys::PSY.PowerSystem; kwargs...)
    ...
    constructdevice!(ps_m, netinjection, category, category_formulation, AbstractDCPowerModel, sys; kwargs...)
