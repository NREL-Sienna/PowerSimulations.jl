function constructdevice!(ps_m::CanonicalModel, category::Type{R}, category_formulation::Type{D}, system_formulation::Type{S}, sys::PSY.PowerSystem; kwargs...) where {R <: PSY.RenwableGen, D <: AbstractRenewableDispatchForm, S <: PM.AbstractPowerFormulation}
...
function constructdevice!(ps_m::CanonicalModel, category::Type{R}, category_formulation::Type{D}, system_formulation::Type{S}, sys::PSY.PowerSystem; kwargs...) where {R <: PSY.RenwableGen, D <: AbstractRenewableDispatchForm, S <: PM.AbstractActivePowerFormulation}
...
function constructdevice!(ps_m::CanonicalModel, category::Type{R}, category_formulation::Type{PSI.RenewableFixed}, system_formulation::Type{S}, sys::PSY.PowerSystem; kwargs...) where {R <: PSY.RenwableGen, S <: PM.AbstractPowerFormulation}
