function add_variable(ps_m::canonical_model, devices::Array{T,1}, time_range::UnitRange{Int64}, var_name::String, binary::Bool = false; expression::String, sign::Int64 = 1) where {T <: PowerSystems.PowerSystemDevice}
...
function add_variable(ps_m::canonical_model, devices::Array{T,1}, time_range::UnitRange{Int64}, var_name::String, binary::Bool = false) where {T <: PowerSystems.PowerSystemDevice}
