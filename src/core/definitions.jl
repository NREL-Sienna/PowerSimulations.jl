...
const JuMPAffineExpression3DArrayIntStringInt = JuMP.Containers.DenseAxisArray{
    JuMP.AffExpr,
    3,
    Tuple{Vector{Base.UUID}, Vector{String}, UnitRange{Int64}},
    Tuple{
        JuMP.Containers._AxisLookup{Dict{Base.UUID, Int64}},
        JuMP.Containers._AxisLookup{Dict{String, Int64}},
        JuMP.Containers._AxisLookup{Tuple{Int64, Int64}},
    },
}
