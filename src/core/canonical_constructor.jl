...
function _canonical_model_init(bus_count::Int64,
    ...
    ps_model = CanonicalModel(jump_model,
                            ...
                            Dict{Symbol, JuMP.Containers.DenseAxisArray}(),
                            nothing,
                            Dict{Symbol, JuMPParamAffineExprArray}(:var_active => JuMPParamAffineExprArray(undef, bus_count, time_periods),
                                                                        :var_reactive => JuMPParamAffineExprArray(undef, bus_count, time_periods)),
                            Dict{Symbol,Any}(),
                            Dict{Symbol,Any}(),
                            nothing);
