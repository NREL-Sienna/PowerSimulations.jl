""" 
  ...
  Plot(OperationModelResults)

This function plots a stack plot for the generators in each variable within
the results variables dictionary, and makes a stac plot for all of the variables.
...
Plot(results; plot_type = "bar")

generates a bar plot for each variable, with 10 generators, 
and one bar plot of the 6 variables (7 plots)

kwargs: plot_type = "bar" will generate a bar plot. No kwarg or
plot_type = "stack" will generate a stack plot.

"""

function plot(res::OperationModelResults; kwargs...)
