...
"""
function activepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{D}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, D <: AbstractHydroDispatchForm, S <: PM.AbstractPowerFormulation}
...
"""
function activepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{HydroRunOfRiver}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, S <: PM.AbstractPowerFormulation}
...
This function adds the power limits of renewable energy generators that can be dispatched
"""
function activepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{HydroSeasonalFlow}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, S <: PM.AbstractPowerFormulation}
...
This function adds the power limits of generators when there are no CommitmentVariables
"""
function reactivepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{D}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, D <: AbstractHydroDispatchForm, S <: AbstractACPowerModel}
...
"""
function activepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{D}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, D <: AbstractHydroCommitmentForm, S <: PM.AbstractPowerFormulation}
...
"""
function reactivepower(ps_m::CanonicalModel, devices::Array{H,1}, device_formulation::Type{D}, system_formulation::Type{S}, time_range::UnitRange{Int64}) where {H <: PowerSystems.HydroGen, D <: AbstractHydroCommitmentForm, S <: AbstractACPowerModel}
