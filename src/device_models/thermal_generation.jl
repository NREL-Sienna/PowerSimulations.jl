...
function rampconstraints(m::JuMP.Model, pth::PowerVariable, onth::PowerVariable, startth::PowerVariable, stopth::PowerVariable, devices::Array{T,1}, time_periods::Int64) where T <: PowerSystems.ThermalGen
...
function commitmentconstraints(m::JuMP.Model, pth::PowerVariable, onth::PowerVariable, startth::PowerVariable, stopth::PowerVariable, devices::Array{T,1}, time_periods::Int64) where T <: PowerSystems.ThermalGen
