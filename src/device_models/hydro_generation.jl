function generationvariables(m::JuMP.Model, devices::Array{T,1}, time_periods) where T <: PowerSystems.HydroGen
...
"""
function powerconstraints(m::JuMP.Model, phg::PowerVariable, devices::Array{T,1}, time_periods::Int64) where T <: PowerSystems.HydroCurtailment
