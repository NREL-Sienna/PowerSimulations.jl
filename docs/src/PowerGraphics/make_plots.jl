...
PG.bar_plot(re_results; reserves=true, save=path, title="Example Bar Plot with Reserves");
...
PG.plot_demand(system; aggregate=PSY.System, save=path, title="Example Demand Plot by Type");
