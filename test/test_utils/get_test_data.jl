...
thermal_generators5_uc_testing(nodes) = [
    ...
    ThermalStandard(
        ...
        time_limits =          (up = 0.02 * 2.2125, down = 0.02 * 2.2125),
        ramp_limits =          nothing,
    ...
    ThermalStandard(
        ...
        time_limits =           (up = 0.0012 * 5.2, down = 0.0012 * 5.2),
    ...
    ThermalStandard(
        ...
        time_limits =          (up = 0.015 * 2.5, down = 0.015 * 2.5),
    ...
    ThermalStandard(
        ...
        time_limits =           (up = 0.0015 * 7.5, down = 0.0015 * 7.5),
        ramp_limits =           (up = 5.0, down = 3.0),
...
function build_sys_ramp_testing(; kwargs...)
    ...
    gen_ramp = [
        ...
        ThermalStandard(
            ...
            reactive_power_limits = nothing,
            time_limits =           (up = 0.010625 * 2.0, down = 0.010625 * 2.0),
            ramp_limits =           nothing,
            operation_cost =        ThreePartCost((0.0, 1500.0), 0.0, 1.5, 0.75),
            base_power =            100.0,
        ),
