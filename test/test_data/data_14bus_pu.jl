...
thermal_generators14(nodes14) = [
    ThermalStandard(
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThreePartCost((0.0430292599, 20.000), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus2",
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThreePartCost((0.25000, 20.000), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus3",
        ...
        time_limits = nothing,
        ramp_limits = nothing,
        operation_cost = ThreePartCost((0.01000, 40.000), 0.0, 0.0, 0.0),
        base_power = 100.0,
    ),
    ThermalStandard(
        name = "Bus6",
