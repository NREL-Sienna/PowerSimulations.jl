@testset "Renewable DCPLossLess FullDispatch" begin
    ps_model = PSI._canonical_model_init(bus_names, nothing, PM.AbstractPowerFormulation, time_range)
    ...
    ps_model = PSI._canonical_model_init(bus_names, nothing, PM.AbstractPowerFormulation, time_range; parameters = false)
