@testset "Test Reserves from Thermal Dispatch" begin
    ...
    for p in [true, false]
        ...
        symbols = [:Reserve1__VariableReserve_ReserveUp, :Reserve11__VariableReserve_ReserveUp, :Reserve2__VariableReserve_ReserveDown, :ORDC1__ReserveDemandCurve_ReserveUp]
        for sym in symbols
