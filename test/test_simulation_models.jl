...
model_ref_uc= FormulationTemplate(CopperPlatePowerModel, devices, branches, services);
...
model_ref_ed= FormulationTemplate(CopperPlatePowerModel, devices, branches, services);
