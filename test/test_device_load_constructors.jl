...
@testset "PowerLoadDispatch AC- PF with MarketBidCost" begin
    ...
    expr = read_expression(results, "ProductionCostExpression__InterruptiblePowerLoad", table_format = TableFormat.WIDE)
    p_l = read_variable(results, "ActivePowerVariable__InterruptiblePowerLoad", table_format = TableFormat.WIDE)
